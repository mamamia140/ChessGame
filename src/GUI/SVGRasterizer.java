...
public class SVGRasterizer {
	...
	/**
	 * Sets the unit conversion factor to the specified value. This method lets you
	 * choose how units such as 'em' are converted. e.g. 0.26458 is 96dpi (the
	 * default) or 0.3528 is 72dpi.
	 *
	 ...
	 * validating or not, depending on the specified parameter. For futher details
	 * about how media work, see the
	...
	/**
	 * Sets the media to rasterize. The medium should be separated by comma. e.g.
	 * "screen", "print" or "screen, print"
	 *
	...
	/**
	 * Sets the alternate stylesheet to use. For futher details, you can have a look
	 * at the <a href="http://www.w3.org/TR/xml-stylesheet/">Associating Style
